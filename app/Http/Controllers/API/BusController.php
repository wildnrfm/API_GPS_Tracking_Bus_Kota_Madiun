...
// CRUD bus (assignment driver & siswa); business logic di BusService
class BusController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        // Simpan photo langsung ke public/images/buses/ (Storage symlink tidak dipakai)
    ...
    public function update(Request $request, $id)
    {
        ...
        // Simpan photo baru, hapus foto lama jika ada
        if ($request->hasFile('photo')) {
    ...
    // POST update photo bus (file upload atau path string)
    ...
    // GET daftar siswa terdaftar di bus
