...
class AttendanceController extends BaseController
{
    ...
    // Driver scan siswa untuk check-in via QR
    public function scan(Request $request)
    {
        ...
        // Validasi: bus_id dari request diabaikan — backend verifikasi sendiri dari driver login
        // agar driver Bus A tidak bisa scan siswa Bus B meski QR-nya valid.
        ...
        // 1. Cari bus aktif milik driver yang sedang login
        ...
        if (!$studentBusAssignment) {
            // Ambil info bus yang benar untuk pesan error informatif
        ...
        // Cari record attendance berdasarkan qr_id
        ...
        if ($existingAttendance) {
            ...
            // QR sudah di-scan check-in sebelumnya
            ...
            // Status pending — update dengan data scan driver
            ...
            // qr_id tidak dikenal — cek sesi terbuka hari ini
            ...
            // Buat record baru (QR lama sebelum sistem baru)
    ...
    public function checkOut(Request $request)
    {
        ...
        // Checkout hanya boleh di hari yang sama
    ...
    public function index(Request $request)
    {
        ...
        // Default: tampilkan hanya yang sudah discan (exclude pending)
        if ($request->has('status')) {
            $query->where('status', $request->input('status'));
        } else {
            $query->whereIn('status', ['checked_in', 'checked_out'])->whereNotNull('waktu_naik');
        }
    ...
    // Absensi hari ini berdasarkan bus (exclude status pending)
    ...
    // Absensi hari ini untuk siswa tertentu
    ...
    // Absensi hari ini untuk siswa yang sedang login
    public function myAttendanceToday(Request $request)
    {
        ...
        // Urutkan checked_in/checked_out di akhir agar Flutter ambil list.last = status terbaru
